...
Namespace ws_lisa
    ...
    Partial Public Class WS_Lisa
        ...
        Public Function ConsultaPos(ByVal tipo As String, ByVal empresa As String, ByVal CodigoLocal As String, ByVal Cliente As String, ByVal sku As String, ByVal cantidad As String, ByVal ListaPrecio As String, ByVal promocion As String) As System.Data.DataSet
        ...
        '''<remarks/>
        Public Overloads Sub ConsultaPosAsync(ByVal tipo As String, ByVal empresa As String, ByVal CodigoLocal As String, ByVal Cliente As String, ByVal sku As String, ByVal cantidad As String, ByVal ListaPrecio As String, ByVal promocion As String)
            Me.ConsultaPosAsync(tipo, empresa, CodigoLocal, Cliente, sku, cantidad, ListaPrecio, promocion, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ConsultaPosAsync(ByVal tipo As String, ByVal empresa As String, ByVal CodigoLocal As String, ByVal Cliente As String, ByVal sku As String, ByVal cantidad As String, ByVal ListaPrecio As String, ByVal promocion As String, ByVal userState As Object)
